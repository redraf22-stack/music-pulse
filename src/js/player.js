...
function setMasterVolume(v){masterVolume=parseFloat(v);if(musicGainNode&&musicAudioCtx)musicGainNode.gain.setTargetAtTime(volumeToGain(v),musicAudioCtx.currentTime,0.015);else audio.volume=Math.min(1,volumeToGain(v));}
